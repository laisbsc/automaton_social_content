---
layout: post
title: Upcoming Why R Webinar - ${talk_name}
comments: true
published: true
date:  16:00:00
...
On Thursday, ${date} at 7 pm UTC | 8 pm CET, as part of the Why R? Webinar series, we have the honour to host
[${speaker_name}](${website}), from the ${affiliation_1} ${affiliation_2}. She
will talk about the ${talk_name}.
...
<iframe width="560" height="315" ${youtube_embed} frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
